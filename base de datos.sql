...
VALUES
-- Programación I (sección 1→docente 3, sección 2→docente 3)
( 1, 1, '08:00', '10:00', 'Teoría',      1,  3),  
( 2, 3, '08:00', '10:00', 'Laboratorio',  2,  3),

-- Cálculo I (sección 3→docente 4, sección 4→docente 4)
( 3, 2, '09:00', '11:00', 'Teoría',      3,  4),
( 4, 4, '09:00', '11:00', 'Práctica',    4,  4),

-- Derecho Civil (sección 5→docente 5, sección 6→docente 5)
( 5, 1, '14:00', '16:00', 'Teoría',      5,  5),
( 6, 3, '14:00', '16:00', 'Casos',       6,  5),

-- Bases de Datos (sección 7→docente 6, sección 8→docente 6)
( 7, 2, '14:00', '16:00', 'Teoría',      7,  6),
( 8, 4, '14:00', '16:00', 'Laboratorio', 1,  6),

-- Machine Learning (sección 9→docente 7, sección 10→docente 7)
( 9, 3, '16:00', '18:00', 'Teoría',      2,  7),
(10, 5, '16:00', '18:00', 'Proyectos',   3,  7),

-- Algoritmos Avanzados (sección 11→docente 3, sección 12→docente 3)
(11, 4, '08:00', '10:00', 'Teoría',      4,  3),
(12, 5, '08:00', '10:00', 'Laboratorio', 5,  3),

-- Estadística Avanzada (sección 13→docente 4, sección 14→docente 4)
(13, 5, '10:00', '12:00', 'Teoría',      6,  4),
